			...
			<div class="data-width">
				<div class="channel-box .fix">
					...
					<div class="channel-c channel-d">
                        ...
                        <a   class="now_tab_red"  href="<?php echo \Yii::$app->urlManager->createUrl(['storeuser/accountsettings']);?>"> 账户设置 </a>
					</div>
					<div class="channel-r">
...
<!--					<img src="--><?php //echo $details1->data->user_img; ?><!--" alt="">-->
		...
		<div class="account_list">
			<ul class="account_list_tab">
				<li class="now"><a href="<?php echo \Yii::$app->urlManager->createUrl(['storeuser/accountsettings'])?>">安全中心</a></li>
				<!--<li><a href="#">个人资料</a></li>-->
				<li><a href="<?php echo \Yii::$app->urlManager->createUrl(['storeuser/accountsettings','state'=> '1'])?>">提现账户</a></li>
			...
			<ul class="account_list_form tatul">
				<li>
					...
					<span><a href="<?php echo \Yii::$app->urlManager->createUrl(['storeuser/change_password']);?>">修改</a></span>
				</li>
				<!--<li>
					<div class="form_img">
...
<?php echo \Yii::$app->view->renderFile('@app/views/layouts/bottom.php'); ?>
	...
	<script type="text/javascript">
		...
		$('#submit').click(function ()  {
            ...
            $.ajax({
               url:"<?php echo \Yii::$app->urlManager->createUrl(['storeuser/drawal'])?>",
                type:'post',
                dataType:'json',
