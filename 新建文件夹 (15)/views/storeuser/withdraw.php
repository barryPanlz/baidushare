		...
		<div class="w_wrap">
			<div class="w" style="background:#f6f6f6">
						...
						<ul style="margin-top:20px ;">
							...
							<li class="wi_li_right_big">
								<div class="">
                                    ...
                                    <a href="<?php echo \Yii::$app->urlManager->createUrl(['storeuser/accountsettings','state'=> '1'])?>">设置提现账号</a>
								</div>
				...
				<script>
                    <?php if(empty($details2->withdrawalAcclist)){ ?>
                        alert("请先保存提现账户");
                        location.href = "<?php echo \Yii::$app->urlManager->createUrl(['storeuser/accountsettings','state'=> '1']);?>";
                  <?php  }?>
                    $("#submit").click(function(){
                        ...
                        $.ajax({
                            url:"<?php echo \Yii::$app->urlManager->createUrl(['storeuser/withdrawal']);?>",
                            type:"post",
                            dataType:"json",
