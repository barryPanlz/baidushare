...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="<?php echo $pc_style; ?>css/private/agreement.css"/>
			...
			<div class="w">
				<div class="sf">
					<div class="sf_left">
						<h4>用户注册协议</h4>
						<p class="p_14 p_mar1">
							本协议是您与三界生活●区块链商城所有者之间就三界生活三界生活●区块链商城网站服务等相关事宜所订立的契约，请您仔细阅读本注册协议，您点击"同意并继续"按钮后，本协议即构成对双方有约束力的法律文件。
						</p>
						<p class="p_13 p_mar1">
							第1条 本站服务条款的确认和接纳
						</p>
						<p class="p_14 ">
							1.1本站的各项电子服务的所有权和运作权归三界生活●区块链商城所有。用户同意所有注册协议条款并完成注册程序，才能成为本站的正式用户。用户确认：本协议条款是处理双方权利义务的契约，始终有效，法律另有强制性规定或双方另有特别约定的，依其规定。
						</p>
						<p class="p_14 ">
						...
						<p class="p_14 ">
							1.4三界生活●区块链商城保留在中华人民共和国大陆地区法施行之法律允许的范围内独自决定拒绝服务、关闭用户账户、清除或编辑内容或取消订单的权利。
						</p>
						<p class="p_13 p_mar1">
							第2条本站服务
						</p>
						<p class="p_14 ">
							2.1三界生活●区块链商城通过互联网依法为用户提供互联网信息等服务，用户在完全同意本协议及本站规定的情况下，方有权使用本站的相关服务。
						</p>
						<p class="p_14 ">
							2.2用户必须自行准备如下设备和承担如下开支：
						</p>
						<p class="p_14 ">
							（1）上网设备，包括并不限于电脑或者其他上网终端、调制解调器及其他必备的上网装置；						</p>
						<p class="p_14 ">
						...
						<p class="p_14 ">
							3.1用户应自行诚信向本站提供注册资料，用户同意其提供的注册资料真实、准确、完整、合法有效，用户注册资料如有变动的，应及时更新其注册资料。如果用户提供的注册资料不合法、不真实、不准确、不详尽的，用户需承担因此引起的相应责任及后果，并且三界生活●区块链商城保留终止用户使用三界生活●区块链商城各项服务的权利。
						</p>
						<p class="p_14 ">
						...
						<p class="p_14 ">
							3.4用户同意，三界生活●区块链商城拥有通过邮件、短信电话等形式，向在本站注册、购物用户、收货人发送订单信息、促销活动等告知信息的权利。
						</p>
						<p class="p_14 ">
							3.5用户不得将在本站注册获得的账户借给他人使用，否则用户应承担由此产生的全部责任，并与实际使用人承担连带责任。
						</p>
						<p class="p_14 ">
							3.6用户同意，三界生活●区块链商城有权使用用户的注册信息、用户名等信息，进行证据保全，包括但不限于公证、见证等。
						</p>
						<p class="p_13 ">
							第4条 用户依法言行义务
						</p>
						...
						<p class="p_14 ">
							本站上的商品价格、数量、是否有货等商品信息随时都有可能发生变动，本站不作特别通知。由于网站上商品信息的数量极其庞大，虽然本站会尽最大努力保证您所浏览商品信息的准确性，但由于众所周知的互联网技术因素等客观原因存在，本站网页显示的信息可能会有一定的滞后性或差错，对此情形您知悉并理解；三界生活●区块链商城欢迎纠错。
为表述便利，商品和服务简称为"商品"或"货物"。
						...
						<p class="p_14 ">
							您在三界生活●区块链商城平台交易过程中与其他用户发生争议的，您或其他用户中任何一方均有权选择以下途径解决：
						</p>
						<p class="p_14 ">
							（1）与争议相对方自主协商；
						</p>
						<p class="p_14 ">
							（2）使用三界生活三界生活●区块链商城网站提供的争议调处服务；
						</p>
						<p class="p_14 ">
						...
						<p class="p_14 ">
							9.2除非另有明确的书面说明,三界生活●区块链商城不对本站的运营及其包含在本网站上的信息、内容、材料、产品（包括软件）或服务作任何形式的、明示或默示的声明或担保（根据中华人民共和国法律另有规定的以外）。
						</p>
						<p class="p_14 ">
							三界生活●区块链商城不担保本站所包含的或以其它方式通过本站提供给您的全部信息、内容、材料、产品（包括软件）和服务、其服务器或从本站发出的电子信件、信息没有病毒或其他有害成分。
						</p>
						<p class="p_14 ">
							如因不可抗力或其它本站无法控制的原因使本站销售系统崩溃或无法正常使用导致网上交易无法完成或丢失有关的信息、记录等，三界生活●区块链商城会合理地尽力协助处理善后事宜。
						</p>
						<p class="p_13 ">
							第10条 法律管辖和适用
						</p>
						<p class="p_14 ">
							本协议的订立、执行和解释及争议的解决均应适用在中华人民共和国大陆地区适用之有效法律。 如发生本协议与适用之法律相抵触时，则这些条款将完全按法律规定重新解释，而其它有效条款继续有效。 如缔约方就本协议内容或其执行发生任何争议，双方应尽力友好协商解决；协商不成时，任何一方均可向三界生活●区块链商城商城网站服务器所在地有管辖权的人民法院提起诉讼。
						</p>
					</div>
<!--					<div class="s_bottom">-->
<!--						<a href="--><?php //echo Url::toRoute("login/register4");?><!--">同意协议并继续</a>-->
<!--					</div>-->
				</div>
			</div>
		</div>
