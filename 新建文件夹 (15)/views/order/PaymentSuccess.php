		...
		<div class="super_settle_ment super_failure ">
			<div class="settle_ment failure ">
				...
				<div class="prompt_1 Fail">
					...
					<h3> 付款成功等待商家发货 </h3> <br />
					<p> 亲！请你慢慢等待，快递正在快马加鞭。 </p>
				</div>
				
				<div class="order_details">
					<p> 订单号：<span> <?php echo $get["order_no"]; ?> </span> </p>
					<p class="order_details_p1"> 已付金额：<span>   <?php echo $get["order_amount"]; ?>三界石 </span> </p>
					<p class="order_details_p1"> 付款时间：<span>   <?php echo $get["pay_time"]; ?> </span> </p>
					<a class="To_view re_pay1"  href="<?php echo Yii::$app->urlManager->createUrl('user/order');?>"> 查看订单  </a>
				</div>
