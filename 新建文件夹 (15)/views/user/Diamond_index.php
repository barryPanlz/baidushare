...
<!--							<img src="--><?php //echo empty($user_img) ? : $user_img; ?><!--" alt="" />-->
			        ...
			        <div class="per_money per_money1">
			        	<ul>
			        		<li>三界石</li>
			        		<li class="colorF7 fun_money_nub"><?php echo empty($future_currency) ? "0" : $future_currency ?></li>
			        	</ul>
                        <ul>
                            <li>三界宝</li>
                            <li class="colorF7 fun_money_nub"><?php echo empty($future_treasure) ? "0" : $future_treasure ?></li>
                        </ul>
			        	<!--<ul>
			        		<li>人民币</li>
		   	...
		   	<?php if(empty($_GET['type'])){ 
		   	  ...
		   	  <div class="the_order_left">
		   	  	 ...
		   	  	 <ul class="order_Type" id="order_Type">
		   	          ...
		   	          <a class="last1" href="<?php echo \Yii::$app->urlManager->createUrl(['user/order']);?>"> 更多 <img src="<?php echo $pc_style; ?>img/jiantou-icon.png"/> </a>
		   	  	 ...
		   	  	 <ol class="order_title">
		   	  	    <!-- <li class="inquire1 order_title_DDD">
		   	  	 	...
		   	  	 	<li class="order_title_li4"> 金额 </li>
...
<!-- 		   	  	 			   	   <p>  &nbsp;颜色：<span><?php echo empty($val->sku_value) ? : $val->sku_value ; ?></span>&nbsp; &nbsp; &nbsp;   尺码：<span>38</span> </p>
 -->		   	  	 			   </div>
                    ...
                    <?php if ($value->pay_name == '人民币'){ ?>
                             <?php if(!empty($value->order_status)) {
                            if ($value->order_status == 1 ) {
                                echo '<a href="' . \Yii::$app->urlManager->createUrl(['order/newpay1', 'order_no' => $value->order_no,'pay_type' => '1']) . '">立即支付</a>' . '<a class="outs" data-1="1" >取消订单</a>';
                            } } ?>

					<?	}else{?>
                              <?php if(!empty($value->order_status)) {
                            if ($value->order_status == 1 ) {
                                echo '<a href="' . \Yii::$app->urlManager->createUrl(['order/pay_order', 'order_sn' => $value->order_no, 'money' => $value->total_price]) . '">立即支付</a>' . '<a class="outs" data-1="1" >取消订单</a>';
		   	  ...
		   	  <div class="the_order_rig">
		   	  	 ...
		   	  	 <table class="tab once">
		   	  		...
		   	  		<tr> <td>
		   	  		      ...
		   	  		      <td><?php echo empty($values->reg_time) ? : $values->reg_time?></td>
		   	  		</tr>
		   	  		<?php }?>
		   	  		<?php }?>
                  ...
                  <div class="order_details1">
                              ...
                              <div class="box_list">
                                  ...
                                  <ul class="specific specific2" id="specific">
                                              ...
                                              <li>
                                                  <!--<a href="<?php echo \Yii::$app->urlManager->createUrl(['life/goodsdetails','goodsId'=>$value->store_goods_id]); ?>">-->
                                                  	<img src="http://futureshop.oss-cn-qingdao.aliyuncs.com/<?php echo empty($value->goods_img) ? : $value->goods_img; ?>"/>
                                                  	<!--</a>-->
                                                  <div class="instru">
                            ...
                            <p><?php /*echo empty($value->area) ? "": $value->area*/?></p>-->
                                  ...
                                  <div class="logistics1" id="logistics">
                                      ...
                                      <?php
                                          ...
                                          if (empty($value->order_status)){
                                              if($value->is_hot == 1){
                                                  echo '<a href="' . \Yii::$app->urlManager->createUrl(['life/pay_orders', 'order_sn' => $value->store_order_sn]) . '">立即支付</a>'.'<a class="outs" data-1="2" >取消订单</a>';
                                              }else {
                                                  echo '<a href="' . \Yii::$app->urlManager->createUrl(['life/pay_order', 'order_sn' => $value->store_order_sn]) . '">立即支付</a>'.'<a class="outs" data-1="2" >取消订单</a>';
                                              }
                                              //echo '<a href="'. \Yii::$app->urlManager->createUrl(['life/pay_order','order_sn' =>$value->store_order_sn,]).'">立即支付</a>'.'<a href="" class="outs" data-1="2" >取消订单</a>';
                                          }
                                      ?>
                                      <?php  if (empty($value->order_status)){?>
...
//                    $('#bulk').css('display','none')
                ...
                $(".outs").click(function () {
                    ...
                    var the_url  = "<?php echo Yii::$app->urlManager->createUrl(['user/cancel'])?>";
                    console.log('the_url');
                    console.log(the_url);
           ...
           /* $(".order_details1").find("").click(function () {
                
            })
        $(this).parents(".order_details1").find(".number_time_font1").text();*/
		</script>
