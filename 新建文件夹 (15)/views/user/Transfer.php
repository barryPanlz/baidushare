	...
	<head>
		...
		<style type="text/css">
			...
			.modal_order{
				...
				left: 40%;
				top: 474px;
				background: rgba(0,0,0,0.5) url(../../img/baisedegou.png) no-repeat 170px 40px;
				font-size: 24px;
				text-align: center;
				line-height: 240px;
				color: #FFFFFF;
			...
			.tab .myre_tab_touxiang{
				text-indent: 30px;
			}
			.myre_tab_touxiang .photo_naodai{
				width: 38px;
				height: 38px;
				margin-left:30px ;
			}
                ...
                <div class="per_dingdan">
                    <table class="tab">
                        <tr>
                            ...
                            <th class="acc_tab_first" style="width: 30%;"> 流水号 </th>
                            <th style="width: 20%;"> 时间 </th>
                            <th style="width: 20%;"> 转账数额（三界石） </th>
                            <!--		   	  			<th style="width: 10%;"> 三界宝 </th> -->
                            <th style="width: 20%;"> 转入账户 </th>
