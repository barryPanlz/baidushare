	...
	<body>
		...
		<div class="super_general_navi ">
			...
			<div class="general_navi">			
			  ...
			  <a  href="<?php echo $pc_style; ?>index.html" class="color_title_fist1 " >首页</a>
			  <a href="../life/localLive.html" >三界本地</a>
			  <a href="../center/general_index.html"> 三界会员</a>
			  <a href="../others/brand.html" class="now_tab_red">品牌汇 </a>
			  <a href="../others/Share.html" class="end_two margin_rig" > 分享邀请</a>
			  <a href="../others/shopercheck.html" class="end_two margin_rig" >商家入驻 </a>
			<!--二级菜单-->
			...
			<div class="data-width">
				<div class="brand-top">
					...
					<div class="top-box fix">
						<ul class="top-box-up">
							<li>
								<a href=""><img src="<?php echo $pc_style; ?>img/jp1.jpg" alt=""></a>
							</li>
							<li>
								<a href=""><img src="<?php echo $pc_style; ?>img/jp2.jpg" alt=""></a>
							</li>
							<li>
								<a href=""><img src="<?php echo $pc_style; ?>img/jp3.jpg" alt=""></a>
							</li>
							<li class="four">
								<a href=""><img src="<?php echo $pc_style; ?>img/jp4.jpg" alt=""></a>
							</li>
						</ul>
