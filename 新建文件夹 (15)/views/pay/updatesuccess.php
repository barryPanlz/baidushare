		...
		<div class="updata-cont">
			...
			<div class="data-width">
				<div class="main-box main-box1">
					<div class="up_succ">
						<img src="<?php echo $pc_style; ?>img/gou.png" alt="" />
						<p>恭喜，您已成功升级为创业会员</p>
						<a href="<?php echo \Yii::$app->urlManager->createUrl(['user/diamond_index']);?>">返回会员首页</a>
					</div>
					...
					<div class="up_list">
						...
						<ul>
							<li class="li_1 li_b">推荐的普通会员升级为钻石会员时的奖励</li>
							<li><img src="<?php echo $pc_style; ?>img/red-shibai.png" alt="" /></li>
							<li><img src="<?php echo $pc_style; ?>img/green-chenggong.png" alt="" /></li>
						</ul>
					</div>
