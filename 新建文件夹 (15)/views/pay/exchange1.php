			...
			<div class="data-width">
				<div class="pay-box">
					...
					<div class="pay-topUp">
						...
						<input type="text"  name="sanjieprice" class="proint_nub" value="人民币" readonly="readonly" data-state="3" id="currency"/>
					</div>
					...
					<div class="pay-topUp">
						...
						<input type="text"  name="sanjieprice" class="proint_nub" value="三界石" readonly="readonly" id="target"/>
					</div>
					<div class="pay-topUp">
                ...
                <div class="page_warp">
						...
						<span>
                             <?php if($page->currentPage >1){ ?>
                                 <a href="<?php echo \Yii::$app->urlManager->createUrl(['pay/exchange1','currentPage' =>$page->currentPage - 1])?>">上一页</a>&nbsp;&nbsp;
                             <?php } ?>

                            <?php  if ($page->currentPage <= 5 && $page->totalPage <= 5){ for($i=1;$i<= $page->totalPage;$i++) { ?>


                                <a href="<?php echo \Yii::$app->urlManager->createUrl(['pay/exchange1','currentPage' =>$i])?>" <?php if($page->currentPage == $i){echo 'style="color:red;"';} ?>><?php echo $i;?></a>
                            ...
                            <?php if($page->currentPage < $page->totalPage ){ ?>
                                &nbsp;&nbsp;<a href="<?php echo \Yii::$app->urlManager->createUrl(['pay/exchange1','currentPage' =>$page->currentPage +1])?>">下一页</a>
                            <?php } ?>
						</span>
                    <span>
						<span>共</span>
                        ...
                        <form action="<?php echo \Yii::$app->urlManager->createUrl(['pay/exchange1']);?>" method="get" >
								<span>跳转到</span>
		...
		<script>
			$(function() {
                ...
                $("#num").blur(function(){
                    ...
                    var sanjieprice =  $("#num").attr("value")* arr[1]/arr[0];
                    sanjieprice = parseFloat(sanjieprice) .toFixed(4);
