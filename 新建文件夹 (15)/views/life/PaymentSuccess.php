		...
		<div class="super_settle_ment super_failure ">
			<div class="settle_ment failure ">
				...
				<div class="order_details">
					...
					<p class="order_details_p1"> 已付金额：<span>   <?php echo empty($info->txamnt)?'':$info->txamnt; ?>  </span> </p>
					<!-- modify_time -->
					<p class="order_details_p1"> 付款时间：<span>   <?php echo empty($info->create_time)? '': $info->create_time;  ?>  </span> </p>
