                                    ...
                                    <?php if($goods_info['is_hot'] == 1) { ?>
                                        <div class="min_cont_mony_right">
                                            <p class="mony_sl1"><span></span>
                                                <!--价格-->
                                                <span><?php echo $goods_info['promote_price']; ?>(三界石)</span>
...
//切换红色边框
			...
			$("#liji").click(function(){
                ...
                <?php if($goods_info['is_hot'] == 1) { ?>
                var is_hot = '1';
			    location.href="<?php echo Yii::$app->urlManager->createUrl('life/futherorder'); ?>?goods_id="+goods_id+"&num="+num+"&is_hot="+is_hot;
			    <?php }else{ ?>
