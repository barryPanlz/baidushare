...
<div class="w_wrap">
	<div class="w">
		...
		<ul class="sp_warp">
            <?php if(!empty($storeHotGoods)) { foreach ($storeHotGoods as $value) { //var_dump($value);die;?>
			<a href="<?php echo \Yii::$app->urlManager->createUrl(['life/goodsdetails','goodsId'=>$value->store_goods_id,'is_hot'=>'1']);?>"><li class="sp-item" >
			  <img src="<?php echo $pic_host.$value->goods_img ?>"/>
				<div class="sp-item-content">
					<div class="sp-money">
						<span><?php echo $value->promote_price ;?></span>
						<b>三界石</b>
					</div>
					<div class="sp-name">
